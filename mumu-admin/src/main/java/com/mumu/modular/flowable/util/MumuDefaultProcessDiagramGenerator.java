 ...
 */
public class MumuDefaultProcessDiagramGenerator implements ProcessDiagramGenerator {
    ...
    public MumuDefaultProcessDiagramGenerator() {
        this(1.0);
    }

    // The instructions on how to draw a certain construct is
    // created statically and stored in a map for performance.
    public MumuDefaultProcessDiagramGenerator(final double scaleFactor) {
        // start event
